                        ...
                        <td>
                          <div class="action-dots">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                              <li><a onclick="deleteJobApplication({{ $application->id }});" class="dropdown-item"
                                  href="javascript:void(0)"><i class="fa fa-trash" aria-hidden="true"></i>
                                  Delete</a></li>
                            </ul>
                          </div>
                        </td>

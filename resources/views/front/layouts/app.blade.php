...
<body data-instant-intensity="mousedown">
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
          ...
          @if (!Auth::guard("admin")->check())
            <a class="btn btn-outline-primary me-2" href="{{ route("acount.login") }}"
              type="submit">Login</a>
          @else
            <a class="btn btn-outline-primary me-2" href="{{ route("acount.profile") }}"
  ...
  <footer class="bg-dark bg-2 py-3">
    <div class="container">
      <p class="fw-bold fs-6 pt-3 text-center text-white">© 2023 xyz company, all right
        reserved</p>
    </div>
  </footer>

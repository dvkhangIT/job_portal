...
@section("title", "Home")
@section("main")
  <section class="section-0 lazy d-flex bg-image-style align-items-center dark" class=""
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-xl-8">
          ...
          <div class="banner-btn mt-5"><a href="#" class="btn btn-primary mb-sm-0 mb-4">Explore Now</a></div>
        </div>
      </div>
    </div>
  </section>
                ...
                @foreach ($featureJobs as $featureJob)
                  <div class="col-md-4">
                    <div class="card mb-4 border-0 p-3 shadow">
                      <div class="card-body">
                        <h3 class="fs-5 mb-0 border-0 pb-2">{{ $featureJob->title }}</h3>

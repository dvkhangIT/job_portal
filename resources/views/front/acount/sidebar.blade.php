<div class="card mb-4 border-0 p-3 shadow">
  <div class="s-body mt-3 text-center">
    <img src="assets/assets/images/avatar7.png" alt="avatar"
      class="rounded-circle img-fluid" style="width: 150px;">
    <h5 class="text-capitalize mt-3 pb-0">{{ Auth::guard("admin")->user()->name }}</h5>
...
<div class="card account-nav mb-lg-0 mb-4 border-0 shadow">
  <div class="card-body p-0">
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item d-flex justify-content-between align-items-center p-3">
        <a href="{{ route("acount.logout") }}">Logout</a>
      </li>
    </ul>
  </div>
</div>

...
use App\Mail\ResestPasswordEmail;
...
class AccountController extends Controller
{
  ...
  public function processRegistration(Request $request)
  {
    ...
    if ($validator->passes()) {
      ...
      $user->save();
      session()->flash('success', 'Your have registerd successfully.');
  ...
  public function authenticate(Request $request)
  {
    ...
    if ($validator->passes()) {
      if (Auth::attempt(['email' => $request->email, 'password' => $request->password])) {
        return redirect()->route('account.profile')->withInput($request->only('email'))->with('success', 'Login successfully.');
      } else {
  ...
  public function deleteJob(Request $request)
  {
    ...
    session()->flash('success', 'Either deleted successfully.');
    return response()->json(['status' => true]);
  }
  ...
  public function processForgotPassword(Request $request)
  {
    ...
    $mailData = [
      'token' => $token,
      'user' => $user,
      'subject' => 'You have required to change your password.',
    ];
    Mail::to($request->email)->send(new ResestPasswordEmail($mailData));
